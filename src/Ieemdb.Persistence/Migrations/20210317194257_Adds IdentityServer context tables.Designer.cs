...
namespace Esentis.Ieemdb.Persistence.Migrations
{
  ...
  [DbContext(typeof(IeemdbDbContext))]
    [Migration("20210317194257_Adds IdentityServer context tables")]
    partial class AddsIdentityServercontexttables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ieemdb.Persistence.Models.Favorite", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ieemdb.Persistence.Models.Rating", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ieemdb.Persistence.Models.Favorite", b =>
                {
                    ...
                    b.HasOne("Ieemdb.Persistence.Identity.IeemdbUser", "User")
                        .WithMany()
